...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<form id="form_report_student" class="well form-horizontal" action="<?php echo Router::url(array('controller'=>'controls','action' => 'reportStudent', 'ext' => 'pdf')); ?>" method="post">
		        <fieldset>
		          	<legend class="text-center">Reporte de Asistencias por Estudiante</legend>
		          	...
		          	<div class="form-group">
		                ...
		                <div class="col-md-6 inputGroupContainer">
		                  	<select id="student" name="student" class="selectpicker form-control" data-live-search="true"
		                           data-live-search-placeholder="Buscar" data-actions-box="true">
		                  	</select>
		                </div>
		          	</div>
