...
<div class="container">
	<div class="row">
		<div class="col-md-12 text-center title-section">
			<h1>Asistencia por Categor&iacute;a</h1>
			<span>
	...
	<div class="row">
		<div class="col-md-offset-1 col-md-10">
			<form id="control_form" class="inline-block" action="POST">
	...
	<div class="modal-dialog" role="document">
	    <div class="modal-content">
	    	<div class="modal-header">
	      	...
	      	<div class="modal-footer">
	      		<a type="button" class="btn btn-primary" href="<?php echo Router::url(array('controller'=>'controls','action' => 'index')); ?>">Aceptar</a>
	      	</div>
	    </div>
	</div>
</div>
