...
<div class="container">
	<div class="row">
		<div class="col-md-12">
			<form id="form_report_bill" class="well form-horizontal" action="<?php echo Router::url(array('controller'=>'bills','action' => 'reportBill', 'ext' => 'pdf')); ?>" method="post">
		        <fieldset>
		          	<legend class="text-center">Reporte de Facturas</legend>
			        ...
			        <div class="form-group">
			          	<label class="col-md-4 control-label">Factura Desde</label>
			          	<div class="col-md-6 inputGroupContainer">
			          		<input type="text" id="bill_code_from" name="bill_code_from" class="form-control" autocomplete="off">
			          	</div>
			        </div>
			        <div class="form-group">
			          	<label class="col-md-4 control-label">Factura Hasta</label>
			          	<div class="col-md-6 inputGroupContainer">
			          		<input type="text" id="bill_code_until" name="bill_code_until" class="form-control" autocomplete="off">
			          	</div>
			        </div>
			        <div class="form-group">
