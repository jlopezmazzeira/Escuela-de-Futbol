...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <div>
                <form class="well form-horizontal" action="<?php echo Router::url(array('controller'=>'users','action' => 'add')); ?>" method="post" id="user_form">
                    <fieldset>
                        ...
                        <div class="form-group has-feedback">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="name" name="name" placeholder="Nombre del usuario" class="form-control" maxlength="80">
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input type="text" id="lastname" name="lastname" placeholder="Apellido del usuario" class="form-control" maxlength="80">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="phone" name="phone" placeholder="0998700398" class="form-control" maxlength="13">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    ...
                                    <input type="text" id="email" name="email" placeholder="pedro.tovar@gmail.com" class="form-control" maxlength="80">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 inputGroupContainer">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                    <input type="text" id="username" name="username" placeholder="tovarpedro241" class="form-control" maxlength="30">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <div class="radio">
                                    <label>
                                        <input type="radio" id="role_a" name="role" value="1" checked />Administrador
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input type="radio" id="role_p" name="role" value="3" /> Profesor
                                    </label>
                                </div>
                            </div>
                        </div>
                            ...
                            <div id="teacherInformacion">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 inputGroupContainer">
                                            <select name="data[Category][]" class="selectpicker form-control" multiple data-live-search="true"
