...
<div class="container">
	<div class="row">
		<div class="col-md-12 text-center title-section">
			<h1>Ordenes de Pagos por Estudiante</h1>
			<span>
		...
		<div class="table-responsive">
  			<table class="table order-table">
				...
				?>
						<tr>
							<td><?php echo $i; ?></td>
							<td><?php echo $pending_payment['s']['lastname']." ".$pending_payment['s']['name']; ?></td>
							...
							<td>
		                        <a href="<?php echo Router::url(array('controller'=>'orders','action' => 'paymentOrder/'.$pending_payment['Order']['id'])); ?>" title="Procesar orden"><i class="glyphicon glyphicon-list-alt action"></i></a>

		                        <a href="<?php echo Router::url(array('controller'=>'orders','action' => 'detailOrder/'.$pending_payment['Order']['id'])); ?>" title="Ver detalle"><i class="glyphicon glyphicon-th-list action"></i></a>
				...
				?>
					<tr>
						<td colspan="6" class="text-center">El estudiantes no posee deudas</td>
					</tr>
				<?php } ?>
				</tbody>
			</table>
